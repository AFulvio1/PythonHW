...
def es(lista1, lista2):
    lista2_bis = lista2.copy()
    for i in lista1:
        if i[0] == 'e':
            ind1 = lista2_bis.index(int(i[1:]))
            del lista2_bis[ind1]
        elif i[0] == 's':
            ind2 = lista2_bis.index(int(i[1:]))
            a,b = lista2_bis[ind2],lista2_bis[ind2+1]
            lista2_bis[ind2],lista2_bis[ind2+1] = b,a
    return lista2_bis
    pass
